...
It begin(List* list);
It end(List* last);
void _insert(List* list, It pos, ElemType x);
//
...
//
void push_back(List* list, ElemType x) { _insert(list, end(list), x); }
//
/*
void push_back(List*list,ElemType x)
{
...
//
void push_front(List* list, ElemType x) { _insert(list, begin(list), x); }
//
